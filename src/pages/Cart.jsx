                                            ...
                                            {similarItems.map((item) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="group relative w-50 h-48 overflow-hidden">
                                                        <img
                                                            src={item.images?.[0] || "https://via.placeholder.com/200x200"} // Placeholder if no image
                                                            alt={item.name || "Product"}
                                                            className="w-full h-full object-cover"
                                                        />
                                                        <span
                                                    ...
                                                    <div className="p-3 flex flex-col">
                                                        ...
                                                        <p className="text-xs text-gray-600 mb-1">Ad by Etsy seller</p> {/* Placeholder for seller info */}
