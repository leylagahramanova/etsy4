    ...
    return (
        ...
        <form className="flex justify-between max-w-md w-full mx-auto rounded-full border bg-white border-gray-300 overflow-hidden group focus-within:border-blue-500 focus-within:border-b-2  transition duration-200 "> {/* Added group and focus-within:border-blue-500 */}
          ...
          >
            ...
            <div className="bg-blue-600 text-white text-center py-8 text-xl flex items-center justify-center">
                ...
                <div className="max-w-screen-xs mx-auto  ">
                    ...
                    <div className="md:hidden ">
                        ...
                        <div className="flex justify-center space-x-6 text-2xl mt-4 text-gray-300">
                            <a href="#" aria-label="Instagram" className=" flex items-center justify-center w-12 h-12 rounded-full hover:bg-blue-50 transition duration-200" ><FaInstagram className='w-8 h-8 text-white' /></a>
                            <a href="#" aria-label="Facebook" className=" flex items-center justify-center w-12 h-12 rounded-full hover:bg-blue-50 transition duration-200"><FaFacebookF className='w-8 h-8 text-white' /></a>
                            <a href="#" aria-label="Pinterest" className=" flex items-center justify-center w-12 h-12 rounded-full hover:bg-blue-50 transition duration-200"><FaPinterestP className='w-8 h-8 text-white' /></a>
                            <a href="#" aria-label="Youtube" className=" flex items-center justify-center w-12 h-12 rounded-full hover:bg-blue-50 transition duration-200"><FaYoutube className='w-8 h-8 text-white' /></a>
                        </div>
